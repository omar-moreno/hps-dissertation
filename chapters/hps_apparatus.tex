...
% Should I include a plot of the occupancy here or in the performance section?
% Probably in the performance section.
...
few layers. This made it crucial to choose a sensor technology that would 
reduce the material budget of the SVT modules in order to maximize the mass and
vertex resolutions.  Furthermore, the need to place the SVT in close proximity
to the beam plane made it necessary to choose sensors which were highly tolerant
...
Before being considered for use by the SVT, all sensors were electrically 
characterized.  Specfically, the leakage current was measured as a function
of bias voltage up to a maximum bias of 1000 V.  


1000 V with only () out of () breaking down.  
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth]{images/sensor_iv_curves.png}
